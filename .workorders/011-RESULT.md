...
- Added source-level regression tests for the WO-011 pin indicator contract.
...
- Full suite: `xcodebuild test -scheme ClaudeAlertBot -destination 'platform=macOS' -derivedDataPath build/DerivedData` passed, 158 tests, 0 failures.
